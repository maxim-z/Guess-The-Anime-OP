...
// import './StarShapes.css'; // assuming your CSS is separate

// const StarShapes: React.FC = () => {
...
//     const moveStar = () => {
//       const randomTop = Math.random() * 80; // max 80vh
//       const randomLeft = Math.random() * 80; // max 80vw

//       starEl.style.top = `${randomTop}vh`;
//       starEl.style.left = `${randomLeft}vw`;
//     };
...
//     starEl.addEventListener('animationiteration', moveStar);

//     // Clean up on unmount
//     return () => {
//       starEl.removeEventListener('animationiteration', moveStar);
//     };
//   }, []);
